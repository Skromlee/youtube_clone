<template>
    <div class=" space-y-6 mx-auto p-4 min-w-fit">
        <div class="hover:bg-slate-200 rounded-lg hover:cursor-pointer">
            <div class="mx-4 h-8 my-0">
                <svg class="h-12" viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" style="pointer-events: none; width: 100%; height: 100%;"><g class="style-scope yt-icon"><path d="M4,10V21h6V15h4v6h6V10L12,3Z" class="style-scope yt-icon"></path></g></svg>
            </div>
            <div class="mx-auto text-center my-0 text-xs">
                Home
            </div>
        </div>
